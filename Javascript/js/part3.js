...
.orient("left");
//<------------------->
d3.json("json/powerByCountry.json",function (error,data) 
{
	// body...
...
//<------------------->
 ...
        yScale.domain([0,d3.max(data,function(d){return d["Purchasing Power in Billions ( Current International Dollar) - 2013"]})]);
...
.enter()
.append('text')
.text(function(d) {return d["Purchasing Power in Billions ( Current International Dollar) - 2013"];})
.attr('x',function(d){return xScale(d["Country Name"])+xScale.rangeBand()/2;})
.attr('y',function(d){return yScale(d["Purchasing Power in Billions ( Current International Dollar) - 2013"])+12;})
.style("fill","white")
